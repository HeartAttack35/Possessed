...
screen navigation():
    ...
    vbox:
        ...
        # Definir color dinámico según si estamos en el menú principal
        python:
            if main_menu:
                menu_color = "#000000"  # negro en menú principal
            else:
                menu_color = "#808080"  # gris fuera del menú principal

        # Botones principales
        if main_menu:
            textbutton _("Iniciar") action Start("intro") text_color menu_color text_hover_color "#E78E2E"
        else:
            textbutton _("Historial") action ShowMenu("history") text_color menu_color text_hover_color "#E78E2E"
            textbutton _("Guardar") action ShowMenu("save") text_color menu_color text_hover_color "#E78E2E"

        # Botones siempre visibles
        textbutton _("Cargar") action ShowMenu("load") text_color menu_color text_hover_color "#E78E2E"
        textbutton _("Ajustes") action ShowMenu("preferences") text_color menu_color text_hover_color "#E78E2E"

        if _in_replay:
            textbutton _("Terminar Replay") action EndReplay(confirm=True) text_color menu_color text_hover_color "#E78E2E"
        elif not main_menu:
            textbutton _("Menú principal") action MainMenu() text_color menu_color text_hover_color "#E78E2E"

        textbutton _("Acerca de...") action ShowMenu("about") text_color menu_color text_hover_color "#E78E2E"

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            textbutton _("Ayuda") action ShowMenu("help") text_color menu_color text_hover_color "#E78E2E"

        if renpy.variant("pc"):
            textbutton _("Salir") action Quit(confirm=not main_menu) text_color menu_color text_hover_color "#E78E2E"
...
define config.main_menu_music = "<loop 28.25>music/menu.ogg"
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %d de %B de %Y, %H:%M"), empty=_("ranura vacía")):
            ...
            vbox:
                ...
                if config.has_sync:
                    if CurrentScreenName() == "save":
                        textbutton _("Subir sincronización"):
                            action UploadSync()
                            xalign 0.5
                    else:
                        textbutton _("Descargar sincronización"):
                            action DownloadSync()
                            xalign 0.5
...
screen keyboard_help():
    ...
    hbox:
        label "V"
        text _("Activa/desactiva {a=https://www.renpy.org/l/voicing}auto-voz{/a}.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Bumper derecho")
        text _("Avanza al diálogo siguiente.")

    hbox:
        label _("D-Pad, Palancas")
        text _("Navegar por la interfaz.")
...
################################################################################
## Timer de escape — Cap 12
## Muestra el tiempo restante en pantalla durante la secuencia de QTEs.
## Se activa con: show screen timer_escape
## Se desactiva con: hide screen timer_escape
################################################################################
...
screen timer_escape():
    ...
    timer 1.0 repeat True action [
        If(tiempo_escape > 0,
            SetVariable("tiempo_escape", tiempo_escape - 1),
